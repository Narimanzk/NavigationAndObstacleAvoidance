...
public class Odometer implements Runnable {
  ...
  /** x coordinate of default starting point in meters. */
  private static final double SX = 0.1524;
  /** y coordinate of default starting point in meters. */
  ...
  public static void updateDeltaPosition(int[] prev, int[] curr, double theta, double[] deltas) {
    ...
    double distL = Math.toRadians(WHEEL_RAD * (curr[LEFT] - prev[LEFT]));
    double distR = Math.toRadians(WHEEL_RAD * (curr[RIGHT] - prev[RIGHT]));
    ...
    double dtheta = (distL - distR) / BASE_WIDTH;
    theta += dtheta;
